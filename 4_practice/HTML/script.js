...
async function handleUserInput() { // Fixed function name
...
sendButton.addEventListener("click", handleUserInput); // Fixed function name
userInput.addEventListener("keypress", (event) => {
    if (event.key === "Enter") {
        handleUserInput(); // Fixed function name
    }
});
